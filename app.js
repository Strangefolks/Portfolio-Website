...
const metadataIcons = {
  Industry: `<svg class="meta-icon" width="28" height="28" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.2" aria-hidden="true"><path d="M1.75 12V7.75L4.5 6l2.75 1.75V12" stroke-linejoin="round"/><path d="M7.75 12V5.5l2.75-1.75L13.25 5.5V12" stroke-linejoin="round"/><rect x="9.75" y="2.25" width="1.75" height="2.5" rx="0.25"/><path d="M10.625 1.75v.9" stroke-linecap="round"/><path d="M10.125 1.35c0-.35.35-.5.5-.5s.5.15.5.5" stroke-linecap="round"/></svg>`,
